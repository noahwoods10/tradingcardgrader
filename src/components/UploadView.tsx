  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="text-center mb-12">
        <h1 className="text-[32px] md:text-[48px] font-medium tracking-tight text-foreground leading-tight mb-4">
      ...
      {/* Upload Zone */}
      <div
        className={`relative border border-dashed rounded-2xl min-h-[220px] flex flex-col items-center justify-center cursor-pointer transition-all duration-150 ${
          dragOver
      ...
      <div className="flex justify-center mt-8">
        <button
          ...
          className="h-12 px-8 rounded-lg bg-primary text-primary-foreground font-medium text-sm transition-all duration-150 hover:opacity-90 disabled:opacity-30 disabled:cursor-not-allowed"
        >
          Analyze my card →
        </button>
      </div>
